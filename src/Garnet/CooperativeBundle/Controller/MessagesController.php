...
use Garnet\CooperativeBundle\Entity\Messages;
use Garnet\CooperativeBundle\Form\MessagesType;
...
class MessagesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GarnetCooperativeBundle:Messages')->findAll();
     ...
     * @Method("POST")
     * @Template("GarnetCooperativeBundle:Messages:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GarnetCooperativeBundle:Messages')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GarnetCooperativeBundle:Messages:edit.html.twig")
     */
